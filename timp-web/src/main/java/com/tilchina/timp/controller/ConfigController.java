...
*/
@RestController
@RequestMapping(value = {"/s1/config"}, produces = {"application/json;charset=utf-8"})
@Slf4j
public class ConfigController extends BaseControllerImpl<Config>{
    ...
    public ApiResult<String> delete(@RequestBody ApiParam<Long> param) {
        ...
        try {
            configservice.deleteById(param.getData());
    ...
    public ApiResult<String> deleteList(@RequestBody ApiParam<int[]> param) {
        ...
        try {
        	...
        	configservice.deleteList(param.getData());
            return ApiResult.success(LanguageUtil.getMessage("0000"));
        } catch (Exception e) {
	...
	@Auth(ClientType.WEB)
    public ApiResult<String> putPartList(@RequestBody ApiParam<List<Config>> param) {
        log.debug("put: {}", param);
        try {
            
        	configservice.update(param.getData());
            return ApiResult.success(LanguageUtil.getMessage("0000"));
        } catch (Exception e) {
            log.error(LanguageUtil.getMessage("9999"),"param={}", param, e);
            return ApiResult.failure("9999", e.getMessage());
    ...
    @Override
    @Auth(ClientType.WEB)
    public ApiResult<Config> getById(@RequestBody ApiParam<Long> param) {
        log.debug("get: {}", param);
        try {
        	Config t = getService().queryById(param.getData());
    ...
    @Override
    @Auth(ClientType.WEB)
    public ApiResult<List<Config>> getList(@RequestBody ApiParam<Map<String, Object>> param) {
        log.debug("getList: {}", param);
        try {
            PageInfo<Config> pageInfo = getService().queryList(param.getData(), param.getPageNum(), param.getPageSize());
    ...
    public ApiResult<String> post(@RequestBody ApiParam<String> param) {
        ...
        try {
            ...
            Config t = (Config)JSON.parseObject(param.getData(), clazz);
            getService().add(t);
            return ApiResult.success(LanguageUtil.getMessage("0000"));
        } catch (Exception e) {
